...
import styles from '../../../css_pages/UserPage.module.css';
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.pointsRow}>
            ...
            {isCurrentUser() && (
              <Link href={`/u/${username}/profile`} className={styles.editBtn}>
                <User size={16} />
                <span>管理我的资料</span>
              </Link>
            )}
                ...
                <div className={styles.postsGrid}>
                  {posts.map((post) => (
                    <article key={post.id} className={styles.postCard}>
                      {post.coverImage && (
                        <Link href={`/post/${post.slug}`} className={styles.postCoverWrap}>
                          <img
                            src={post.coverImage}
                            alt={post.title}
                      ...
                      <div className={styles.postContent}>
                        <div className={styles.postMeta}>
                          {post.categoryName && (
                            <Link href={`/category/${post.categorySlug}`} className={styles.postCategory}>
                              {post.categoryName}
                            </Link>
                          )}
