...
import styles from '@/css_pages/CategoryPage.module.css';
...
export default function CategoryPage() {
  ...
  }, [category, slug, pageNum, currentPage, totalPages, router]);

  function handlePageChange(page) {
    if (page === 1) router.push(`/category/${slug}`);
    else router.push(`/category/${slug}/page/${page}`);
    window.scrollTo({ top: 0, behavior: 'smooth' });
  }

  function handleSortChange(newSort) {
    setSort(newSort);
    if (currentPage !== 1) router.push(`/category/${slug}`);
  }
