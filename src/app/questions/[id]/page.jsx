...
import styles from '../../../css_pages/QuestionDetail.module.css';
...
export default function QuestionDetail() {
  ...
  return (
    <div className={styles.questionDetail}>
      <button className={styles.backBtn} onClick={() => router.push('/questions')}>
        <ArrowLeft size={18} />
        <span>返回问答</span>
      </button>
      ...
      {user && (
        <div className={styles.answerForm}>
          ...
          <div className={styles.formActions}>
            <button className={styles.cancelButton} onClick={() => router.push('/questions')}>
              取消
            </button>
