...
import styles from '../../css_pages/Questions.module.css';
  ...
  return (
    <div className={styles.questionsPage}>
      <div className={styles.header}>
        ...
        <button className={styles.askButton} onClick={() => router.push('/questions/ask')}>
          提问
        </button>
      </div>
      ...
      <div className={styles.questionsList}>
        {loading && questions.length === 0 ? (
          ...
          <div className={styles.empty}>
            ...
            <p>暂无问题</p>
            <button className={styles.emptyBtn} onClick={() => router.push('/questions/ask')}>提出第一个问题</button>
          </div>
        ) : (
