export const categories = [
  ...
  { id: 2, name: '设计', slug: 'design', count: 5 },
  { id: 3, name: '生活', slug: 'life', count: 4 },
  { id: 4, name: '前端', slug: 'frontend', count: 6 },
  { id: 5, name: '思考', slug: 'thoughts', count: 3 },
];

export const author = {
  name: '墨客',
  avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=blogger&backgroundColor=2563eb',
  bio: '前端开发者 & 技术写作者。热爱探索新技术，分享编程心得与生活感悟。',
  stats: { posts: 26, followers: 1850, readingTime: '120h' },
};
...
\`\`\`jsx
// React 18 中，这两个 setState 会被合并为一次重渲染
setTimeout(() => {
  setCount(c => c + 1);
  setFlag(f => !f);
}, 1000);
...
在实际项目中，并发模式可以帮助我们解决很多性能问题。但需要注意的是，不是所有场景都需要使用并发模式，合理的分析需求场景才是关键。`,
    ...
    views: 2840,
    comments: [
      { id: 1, author: '小明', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=xiaoming', content: '写得非常详细，对并发模式的理解又加深了。', createdAt: '2024-12-16T10:30:00Z' },
      { id: 2, author: 'TechGirl', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=techgirl', content: 'Transition 的部分解释得很清楚，解决了我一直以来的疑惑。', createdAt: '2024-12-17T14:20:00Z' },
      { id: 3, author: '代码君', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=coder', content: '期待后续关于 Streaming SSR 的文章！', createdAt: '2024-12-18T09:15:00Z' },
    ],
  },
  {
    id: 2,
...
Container Queries 让组件真正实现了"一次编写，处处适配"的承诺。`,
    ...
    views: 1560,
    comments: [
      { id: 4, author: '设计狮', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=designer', content: 'Container Queries 真是前端开发的福音！', createdAt: '2024-12-11T08:00:00Z' },
    ],
  },
  {
    id: 3,
...
Vite 让前端开发体验提升到了一个新的高度。`,
    ...
    views: 2100,
    comments: [
      { id: 5, author: 'NodeMaster', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=node', content: '用了 Vite 就回不去了！', createdAt: '2024-12-06T11:00:00Z' },
      { id: 6, author: '初学者', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=newbie', content: '配置比我想象中简单很多，谢谢分享！', createdAt: '2024-12-07T16:30:00Z' },
    ],
  },
  {
    id: 4,
...
选择一个主色（Primary Color）和一个辅色（Secondary Color），搭配中性色（灰阶）构成完整的色板。
...
好的设计是隐形的，用户不会注意到它，但会感受到使用过程中的舒适。`,
    ...
    views: 1890,
    comments: [
      { id: 7, author: '像素眼', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=pixel', content: '配色方案那段非常实用！', createdAt: '2024-11-29T13:00:00Z' },
    ],
  },
  {
    id: 5,
...
掌握这些高级类型技巧，能让你写出更安全、更优雅的代码。`,
    ...
    views: 3200,
    comments: [
      { id: 8, author: 'TS狂人', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=tsfan', content: '太棒了！建议再加一些 infer 的使用案例。', createdAt: '2024-11-21T09:00:00Z' },
      { id: 9, author: 'Java转前端', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=javadev', content: 'TypeScript 的类型系统真的强大！', createdAt: '2024-11-22T15:00:00Z' },
    ],
  },
  {
    id: 6,
...
极简不是简陋，而是剔除冗余后留下的精华。`,
    ...
    views: 2450,
    comments: [
      { id: 10, author: '效率控', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=efficiency', content: 'Obsidian 确实好用，推荐配合 Dataview 插件！', createdAt: '2024-11-16T10:00:00Z' },
      { id: 11, author: 'Vim信徒', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=vimuser', content: '同为 Neovim 用户，握手！', createdAt: '2024-11-17T08:30:00Z' },
      { id: 12, author: '小白的旅程', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=white', content: 'Warp 看起来不错，试试看！', createdAt: '2024-11-18T19:00:00Z' },
    ],
  },
  {
    id: 7,
...
掌握异步编程是每个 JavaScript 开发者的必修课。`,
    ...
    category: categories[0],
    tags: ['JavaScript', '异步', '前端'],
    author,
    publishedAt: '2024-11-10T08:00:00Z',
    views: 4100,
    comments: [
      { id: 13, author: 'JS新手', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=jsnewbie', content: '讲得很清楚，回调地狱那段深有感触！', createdAt: '2024-11-11T07:00:00Z' },
    ],
  },
  {
    id: 8,
...
设计系统不是一蹴而就的，它需要持续迭代和维护。`,
    ...
    views: 1350,
    comments: [
      { id: 14, author: '组件控', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=component', content: '推荐使用 Storybook 来管理组件文档。', createdAt: '2024-11-06T14:00:00Z' },
    ],
  },
  {
    id: 9,
...
保持学习，但不要盲目追求新。选择适合项目需求的技术才是关键。`,
    ...
    category: categories[0],
    tags: ['前端趋势', 'WebAssembly', 'AI'],
    author,
    publishedAt: '2024-10-28T08:00:00Z',
    views: 5600,
    comments: [
      { id: 15, author: '技术早报', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=news', content: '总结得很全面！', createdAt: '2024-10-29T09:00:00Z' },
      { id: 16, author: 'AI爱好者', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=aifan', content: 'AI 辅助开发这块确实变化太快了。', createdAt: '2024-10-30T11:00:00Z' },
    ],
  },
  {
    id: 10,
...
理解原理后，选择框架就变得更加得心应手了。`,
    ...
    views: 1780,
    comments: [
      { id: 17, author: '架构师老王', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=architect', content: '沙箱隔离的实现思路很清晰！', createdAt: '2024-10-16T08:00:00Z' },
    ],
  },
  {
    id: 12,
...
读书不在于多，而在于消化和运用。`,
    ...
    views: 3100,
    comments: [
      { id: 18, author: '书虫', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=bookworm', content: 'Zettelkasten 方法确实好用！', createdAt: '2024-10-09T20:00:00Z' },
      { id: 19, author: '学习者', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=learner', content: '请问有没有推荐的书单？', createdAt: '2024-10-10T12:00:00Z' },
    ],
  },
  {
    id: 13,
...
性能优化是一个持续的过程，需要不断测量和改进。`,
    ...
    views: 2300,
    comments: [
      { id: 20, author: '性能控', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=perf', content: 'LCP 优化那块可以再深入一些。', createdAt: '2024-09-29T14:00:00Z' },
    ],
  },
  {
    id: 14,
...
Node.js 生态已经足够成熟，可以支撑大型生产级应用。`,
    ...
    views: 1650,
    comments: [
      { id: 21, author: '全栈小王子', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=fullstack', content: '项目结构建议很实用！', createdAt: '2024-09-21T11:00:00Z' },
    ],
  },
  {
    id: 15,
...
数字游民不是度假，而是一种需要高度自律的生活方式。`,
    ...
    views: 4200,
    comments: [
      { id: 22, author: '流浪的程序员', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=nomad1', content: '同在旅居中，有机会面基！', createdAt: '2024-09-16T22:00:00Z' },
      { id: 23, author: '居家办公者', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=homeoffice', content: '时间管理那部分启发很大。', createdAt: '2024-09-17T09:00:00Z' },
    ],
  },
  {
    id: 16,
...
好的配色方案能让产品更有说服力。`,
    ...
    views: 1100,
    comments: [
      { id: 24, author: '产品经理小刘', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=pm', content: '这篇文章对我们产品的改版很有启发！', createdAt: '2024-09-02T15:00:00Z' },
    ],
  },
  {
    id: 18,
...
善用命令行，让你的开发效率提升一个台阶。`,
    ...
    views: 2800,
    comments: [
      { id: 25, author: '终端达人', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=terminal', content: 'fzf 真的用了就回不去！', createdAt: '2024-08-26T10:00:00Z' },
    ],
  },
  {
    id: 19,
...
从今天开始，试着把你学到的知识写下来。`,
    ...
    views: 3500,
    comments: [
      { id: 26, author: '技术博主', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=blogger2', content: '深有同感！写作真的改变了我。', createdAt: '2024-08-11T09:00:00Z' },
      { id: 27, author: '默默学习的后端', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=backenddev', content: '感谢鼓励，决定开始写技术博客了。', createdAt: '2024-08-12T22:00:00Z' },
    ],
  },
];

export const recentComments = posts
  .flatMap((post) =>
...
export const popularPosts = [...posts].sort((a, b) => b.views - a.views).slice(0, 5);
