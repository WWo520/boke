          ...
          <section className={styles.card}>
            <div className={styles.cardHeader}>
              ...
              <div className={styles.cardHeaderRight}>
                ...
                <Link to={`/u/${username}/write`} className={styles.newPostBtn}>
                  <Plus size={16} />
                  <span>写文章</span>
                </Link>
              </div>
            ...
            {postsLoading ? (
              ...
              <div className={styles.postsEmpty}>
                ...
                <p>还没有发布文章</p>
                <Link to={`/u/${username}/write`} className={styles.emptyAction}>
                  <Plus size={16} />
                  发布第一篇文章
                </Link>
              </div>
                ...
                {posts.map((post) => (
                  <div key={post.id} className={styles.postItem}>
                    ...
                    <div className={styles.postInfo}>
                      <Link to={`/post/${post.slug}`} className={styles.postTitle} target="_blank">
                        {post.title}
                      </Link>
                    ...
                    <div className={styles.postActions}>
                      <Link to={`/u/${username}/write/${post.id}`} className={styles.actionBtn} aria-label="编辑">
                        <Edit2 size={16} />
                      </Link>
                      {post.status === 'draft' && (
                        <button
